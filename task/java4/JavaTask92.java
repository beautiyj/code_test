...
// 지금까지 배운 클래스들은 모두 데이터를 바이트나 문자 단위로만 취급하고 입출력 했음
// 정수형이나 실수형 같은 기본 데이터 타입을 유지 하면서 입.출력하는 방법은?

// 기본 타입 입출력 스트림 DataInputStream, DataOutputStream 클래스를 이용하는 방법
