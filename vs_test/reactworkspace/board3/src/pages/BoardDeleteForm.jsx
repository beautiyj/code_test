...
export const BoardDeleteForm = () => {
    ...
    useEffect(() => {
        ...
        axios.get('http://localhost:9999/boarddeleteform/'+no)
            .then((res) => {
    ...
    const handleSubmit = (e) => {
        ...
        // axios를 이용하여 DELETE 방식으로 데이터 전송          
        axios.delete('http://localhost:9999/boarddelete/'+no)   
            .then((res) => {
