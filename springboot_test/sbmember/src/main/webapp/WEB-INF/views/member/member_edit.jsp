   ...
   <table id="join_t">
    ...
    <tr>
     ...
     <%@ include file="../include/tel_number.jsp"%>
      ...
      <input name="join_tel2" id="join_tel2" size="4" maxlength="4" class="input_box" value="${editm.join_tel2}"/>-
      <input  name="join_tel3" id="join_tel3" size="4" maxlength="4" class="input_box"  value="${editm.join_tel3}"/>
     </td>
    </tr>
    ...
    <tr>
     ...
     <input name="join_phone2" id="join_phone2" size="4" maxlength="4" class="input_box" value="${editm.join_phone2}"/>-
     <input name="join_phone3" id="join_phone3" size="4" maxlength="4" class="input_box" value="${editm.join_phone3}"/>
     </td>
    </tr>
    ...
    <tr>
     ...
     <td>
      ...
      class="input_box" value="${editm.join_mailid}"/>@<input name="join_maildomain" 
      id="join_maildomain" size="20" class="input_box" readonly value="${editm.join_maildomain}" />
      
      <!--readonly는 단지 쓰기,수정이 불가능하고 읽기만 가능하다 -->
      <select onchange="domain_list()">
      <option value="">=이메일선택=</option>
      <option value="daum.net" 
      		<c:if test="${editm.join_maildomain == 'daum.net'}">${'selected'}
            </c:if>>daum.net</option>
      <option value="nate.com" 
      		<c:if test="${editm.join_maildomain == 'nate.com'}">${'selected'}
            </c:if>>nate.com</option>
      <option value="naver.com" 
      		<c:if test="${editm.join_maildomain == 'naver.com'}">${'selected'}
            </c:if>>naver.com</option>
      <option value="hotmail.com" 
            <c:if test="${editm.join_maildomain == 'hotmail.com'}">${'selected'}
            </c:if>>hotmail.com</option>
      <option value="gmail.com" 
            <c:if test="${editm.join_maildomain == 'gmail.com'}">${'selected'}
